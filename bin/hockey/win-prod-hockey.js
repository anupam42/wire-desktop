...
checkEnvVars(['WIN_PROD_HOCKEY_ID', 'WIN_PROD_HOCKEY_TOKEN', 'WRAPPER_BUILD']);

const HOCKEY_ID = process.env.WIN_PROD_HOCKEY_ID;
const HOCKEY_TOKEN = process.env.WIN_PROD_HOCKEY_TOKEN;
const VERSION = process.env.WRAPPER_BUILD.split('#')[1];

const wireExe = path.join(__dirname, '../../wrap/prod/Wire-win32-ia32/WireSetup.exe');
